...
SET packageName=Lightweight - Agent Util
...
REM Package Config
SET packageId=0HoP3000000010vKAA
SET packageVersionId=04tP30000016tMDIAY
...
REM /packaging/installPackage.apexp?p0=04tP30000016tMDIAY